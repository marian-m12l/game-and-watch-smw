 ...
 */
static const uint8_t IMG_BORDER_LEFT[] = {
...
static const uint8_t IMG_BORDER_RIGHT[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
void draw_border(pixel_t * fb){
    ...
    for(uint16_t i=0; i < BORDER_HEIGHT; i++){
        ...
        for(uint8_t j=0; j < BORDER_WIDTH; j++){
            fb[offset + j] = 
                (IMG_BORDER_LEFT[bit_index >> 3] << (bit_index & 0x07)) & 0x80 ? BORDER_COLOR_565 : 0x0000;
            bit_index++;
        }
    }
    start = 32 + 256;
    ...
    for(uint16_t i=0; i < BORDER_HEIGHT; i++){
        ...
        for(uint8_t j=0; j < BORDER_WIDTH; j++){
            fb[offset + j] = 
                (IMG_BORDER_RIGHT[bit_index >> 3] << (bit_index & 0x07)) & 0x80 ? BORDER_COLOR_565 : 0x0000;
            bit_index++;
        }
    }
